...
RUN dnf install -y pcs which passwd findutils bind-utils kubernetes-client gettext fence-virt fence-agents-redfish iputils initscripts chkconfig && rm -rf /var/cache/yum
